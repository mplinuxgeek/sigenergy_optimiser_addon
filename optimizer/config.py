...
class Entities:
    ...
    forecast_day_3_sensor: str = "sensor.solcast_pv_forecast_forecast_day_3"
    forecast_day_4_sensor: str = "sensor.solcast_pv_forecast_forecast_day_4"
    forecast_day_5_sensor: str = "sensor.solcast_pv_forecast_forecast_day_5"
    forecast_day_6_sensor: str = "sensor.solcast_pv_forecast_forecast_day_6"
    forecast_day_7_sensor: str = "sensor.solcast_pv_forecast_forecast_day_7"
